...
from handlers import (
    ...
    channel_admin, cosmetics, coverguess, daily, discover, economy, fallback, favorites,
    ...
    report, request, requests_manual, revenue, settings_admin, speedread, spin, start, stats,
